...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/default/assets/css/dark-green.css') }}">
                                    ...
                                    <div class="basket-item">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6">
                                                <a href="cart.blade.php" class="le-button inverse">View cart</a>
                                            </div>
                                            <div class="col-xs-12 col-sm-6">
...
<script src="{{ asset('themes/default/assets/js/script.js') }}"></script>
@yield('body_scripts')
